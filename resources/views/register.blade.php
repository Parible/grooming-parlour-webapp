            ...
            <div>
                ...
                {{-- <p class="mt-1 text-white">Login</p> --}}
                  <a href="/login""><button  type="submit"
                    class="mt-4 mb-2 block w-28 rounded-2xl bg-white py-2 font-bold text-red-800">Login</button></a>
            </div>
        </div>
        <div class="flex w-1/2 items-center justify-center bg-white mx-auto  md:p-48">
            ...
            <form method="POST" action="/register" class="bg-white">
              ...
              <img src="{{ asset('/images/groomingimage.jpg')}}" class="h-32 -ml-6 rounded-full" alt="Grooming Image" />
                ...
                <p class="mb-7 text-sm font-normal text-gray-600"></p>
                <div class="mb-4 flex items-center rounded-2xl border-2 py-2 px-3">
                    ...
                    <input class="border-none pl-2 outline-none" type="text" name="name" id=""
                        autocomplete="off" placeholder="First name" value="{{old('name')}}"/>
                ...
                <div class="mb-4 flex items-center rounded-2xl border-2 py-2 px-3">
                    ...
                    <input class="border-none pl-2 outline-none" type="email" name="email" id="" autocomplete="off"
                ...
                <div class="flex items-center rounded-2xl border-2 py-2 px-3">
                    ...
                    <input class="border-none pl-2 outline-none" type="password" name="password" id="" autocomplete="off"
                ...
                <div class="mt-4 flex items-center rounded-2xl border-2 py-2 px-3">
                    ...
                    <input class="border-none pl-2 outline-none" type="password" name="password_confirmation" autocomplete="off"
                ...
                <button type="submit"
                    class="mt-4 mb-2 block w-full rounded-2xl  bg-gradient-to-tr from-red-800 to-red-500 py-2 font-semibold text-white">Sign
                    Up</button>
                {{-- <span class="ml-2 cursor-pointer text-sm hover:text-blue-500">Forgot Password ?</span> --}}
                <h1 class="mt-3">Already have an account? <a href="/login" class="text-red-800">Login</a></h1>
            </form>
