...
<div class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="bg-white rounded-xl border border-gray-200 shadow-lg p-4 sm:p-7 dark:bg-slate-900">
    ...
    Upload photo
        ...
        <div class="sm:col-span-9">
          <input type="text" name="staff_name" value="{{old('staff_name')}}" autocomplete="off" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Enter staff name">
          @error('staff_name')
        ...
        <div class="sm:col-span-9">
          <div class="space-y-2">
            <input  type="text" name="location" value="{{old('location')}}" autocomplete="off" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Enter current location">
            @error('location')
                                    <p class="mt-1 bg-white text-xs font-bold text-red-500">{{ $message }}</p>
                                @enderror
                     </div>
        ...
        <div class="space-y-2">
            <input  type="text" name="contact" value="{{old('contact')}}" autocomplete="off" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Enter phone number">
            @error('contact')
                                    <p class="mt-1 bg-white text-xs font-bold text-red-500">{{ $message }}</p>
                                @enderror
                     </div>
